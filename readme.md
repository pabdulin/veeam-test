...
Солюшен `veeam-test.sln`.

Реализивано в виде библиотеки `Compress.Lib` и использующего её приложения `GZipTest`.

Тестовый проект `Compress.Lib.Tests`, он сделан для удобства запуска локальной отладки и не претендует на настоящие тесты.
